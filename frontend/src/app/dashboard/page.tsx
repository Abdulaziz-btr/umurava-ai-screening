  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div onClick={() => router.push("/dashboard/jobs/new")}
        ...
        <div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            {jobs.slice(0, 5).map((job, i) => (
              <div key={job._id} onClick={() => router.push(`/dashboard/jobs/${job._id}`)}
                className={`flex items-center justify-between px-5 py-4 cursor-pointer hover:bg-gray-50 transition ${i < Math.min(jobs.length, 5) - 1 ? "border-b border-gray-100" : ""}`}>
                <div>
